...
console.log("Ejemplo 3: Imprimiendo la lista de la países en mayúsculas")
...
const name13 = ['Explorer 1', 'Explorer 2', 'Explorer 3']
const result = name13.findIndex((name) => name.length > 7)
...
const products = ['Mil', 'Coffee', 'Sugar', 'Honey', 'Apple', 'Carrot']
